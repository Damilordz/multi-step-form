...
const Summary = ({ addOnsData, selectedAddOns, updateIndex }) => {
  const { planIndex, planTypes, planPeriod } = usePlan();

  // const adsOnsTotal = selectedAddOns.reduce(
  //   (total, index) => total + addOnsData[index].price,
  //   0
  // );
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      <div className="flex flex-col border rounded-md p-4 bg-neutral-magnolia">
        <div className="flex p-4 pt-0 justify-between items-center">
          <div className="flex gap-4">
            <div className="flex flex-col gap-0">
              ...
              <p
                className="text-gray-400 text-[15px] cursor-pointer hover:underline hover:text-primary-purplish"
                onClick={updateIndex}
              >
                Change
              </p>
